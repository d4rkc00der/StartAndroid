package com.soho.evgeny.contentprovider;
...
public class MyContactsProvider extends ContentProvider {
    ...
    static final String AUTHORITY = "com.soho.evgeny.adressBook";

    static final String CONTACT_PATH = "contacts";

    public static final Uri CONTACT_CONTENT_URI = Uri.parse("content://" + AUTHORITY + "/"
            + CONTACT_PATH);
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        Cursor cursor = db.query(DB_TABLE,projection,selection,selectionArgs,null,null,sortOrder);
